...
tar cfJ cms.tar.xz /bin/ls /bin/ps /bin/echo
ls -l cmd*

tar cJ --backup -f cmd.tar.zx /bin/ls /bin/ps /bin/echo
export SIMPLE_BACKUP_SFFIX=".bak"
...
find /usr/bin/ | xargstar cfz usr-bin.tar.gz
